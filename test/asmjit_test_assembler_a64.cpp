...
static void ASMJIT_NOINLINE testA64AssemblerBase(AssemblerTester<a64::Assembler>& tester) noexcept {
  ...
  TEST_INSTRUCTION("2300423A", ccmn(w1, w2, 3, Cond::kEQ));
  TEST_INSTRUCTION("230042BA", ccmn(x1, x2, 3, Cond::kEQ));
  TEST_INSTRUCTION("2308423A", ccmn(w1, 2, 3, Cond::kEQ));
  TEST_INSTRUCTION("230842BA", ccmn(x1, 2, 3, Cond::kEQ));
  TEST_INSTRUCTION("23005F3A", ccmn(w1, wzr, 3, Cond::kEQ));
  TEST_INSTRUCTION("23005FBA", ccmn(x1, xzr, 3, Cond::kEQ));
  TEST_INSTRUCTION("2300427A", ccmp(w1, w2, 3, Cond::kEQ));
  TEST_INSTRUCTION("230042FA", ccmp(x1, x2, 3, Cond::kEQ));
  TEST_INSTRUCTION("2308427A", ccmp(w1, 2, 3, Cond::kEQ));
  TEST_INSTRUCTION("230842FA", ccmp(x1, 2, 3, Cond::kEQ));
  TEST_INSTRUCTION("23005F7A", ccmp(w1, wzr, 3, Cond::kEQ));
  TEST_INSTRUCTION("23005FFA", ccmp(x1, xzr, 3, Cond::kEQ));
  TEST_INSTRUCTION("1F4000D5", cfinv());
  TEST_INSTRUCTION("4114821A", cinc(w1, w2, Cond::kEQ));
  TEST_INSTRUCTION("4114829A", cinc(x1, x2, Cond::kEQ));
  TEST_INSTRUCTION("5F14821A", cinc(wzr, w2, Cond::kEQ));
  TEST_INSTRUCTION("E1179F1A", cinc(w1, wzr, Cond::kEQ));
  TEST_INSTRUCTION("5F14829A", cinc(xzr, x2, Cond::kEQ));
  TEST_INSTRUCTION("E1179F9A", cinc(x1, xzr, Cond::kEQ));
  TEST_INSTRUCTION("4110825A", cinv(w1, w2, Cond::kEQ));
  TEST_INSTRUCTION("411082DA", cinv(x1, x2, Cond::kEQ));
  TEST_INSTRUCTION("5F10825A", cinv(wzr, w2, Cond::kEQ));
  TEST_INSTRUCTION("E1139F5A", cinv(w1, wzr, Cond::kEQ));
  TEST_INSTRUCTION("5F1082DA", cinv(xzr, x2, Cond::kEQ));
  TEST_INSTRUCTION("E1139FDA", cinv(x1, xzr, Cond::kEQ));
  ...
  TEST_INSTRUCTION("4100831A", csel(w1, w2, w3, Cond::kEQ));
  TEST_INSTRUCTION("4100839A", csel(x1, x2, x3, Cond::kEQ));
  TEST_INSTRUCTION("E1179F1A", cset(w1, Cond::kEQ));
  TEST_INSTRUCTION("E1179F9A", cset(x1, Cond::kEQ));
  TEST_INSTRUCTION("E1179F1A", cset(w1, Cond::kEQ));
  TEST_INSTRUCTION("E1179F9A", cset(x1, Cond::kEQ));
  TEST_INSTRUCTION("E1139F5A", csetm(w1, Cond::kEQ));
  TEST_INSTRUCTION("E1139FDA", csetm(x1, Cond::kEQ));
  TEST_INSTRUCTION("4104831A", csinc(w1, w2, w3, Cond::kEQ));
  TEST_INSTRUCTION("4104839A", csinc(x1, x2, x3, Cond::kEQ));
  TEST_INSTRUCTION("4100835A", csinv(w1, w2, w3, Cond::kEQ));
  TEST_INSTRUCTION("410083DA", csinv(x1, x2, x3, Cond::kEQ));
  TEST_INSTRUCTION("4104835A", csneg(w1, w2, w3, Cond::kEQ));
  TEST_INSTRUCTION("410483DA", csneg(x1, x2, x3, Cond::kEQ));
...
static void ASMJIT_NOINLINE testA64AssemblerSIMD(AssemblerTester<a64::Assembler>& tester) noexcept {
  ...
  TEST_INSTRUCTION("2404E21E", fccmp(h1, h2, 4, Cond::kEQ));
  TEST_INSTRUCTION("2404221E", fccmp(s1, s2, 4, Cond::kEQ));
  TEST_INSTRUCTION("2404621E", fccmp(d1, d2, 4, Cond::kEQ));
  TEST_INSTRUCTION("3404E21E", fccmpe(h1, h2, 4, Cond::kEQ));
  TEST_INSTRUCTION("3404221E", fccmpe(s1, s2, 4, Cond::kEQ));
  TEST_INSTRUCTION("3404621E", fccmpe(d1, d2, 4, Cond::kEQ));
  ...
  TEST_INSTRUCTION("410CE31E", fcsel(h1, h2, h3, Cond::kEQ));
  TEST_INSTRUCTION("410C231E", fcsel(s1, s2, s3, Cond::kEQ));
  TEST_INSTRUCTION("410C631E", fcsel(d1, d2, d3, Cond::kEQ));
