...
public:
  ...
  inline This& cond(uint32_t condCode) noexcept {
    return _addInstOptions(InstOptions(condCode << uint32_t(InstOptions::kARM_CondCodeShift)) | InstOptions::kARM_CondFlagMask);
  }

  inline This& cond_eq() noexcept { return cond(Cond::kEQ); }
  inline This& cond_ne() noexcept { return cond(Cond::kNE); }
  inline This& cond_cs() noexcept { return cond(Cond::kCS); }
  inline This& cond_hs() noexcept { return cond(Cond::kHS); }
  inline This& cond_cc() noexcept { return cond(Cond::kCC); }
  inline This& cond_lo() noexcept { return cond(Cond::kLO); }
  inline This& cond_mi() noexcept { return cond(Cond::kMI); }
  inline This& cond_pl() noexcept { return cond(Cond::kPL); }
  inline This& cond_vs() noexcept { return cond(Cond::kVS); }
  inline This& cond_vc() noexcept { return cond(Cond::kVC); }
  inline This& cond_hi() noexcept { return cond(Cond::kHI); }
  inline This& cond_ls() noexcept { return cond(Cond::kLS); }
  inline This& cond_ge() noexcept { return cond(Cond::kGE); }
  inline This& cond_lt() noexcept { return cond(Cond::kLT); }
  inline This& cond_gt() noexcept { return cond(Cond::kGT); }
  inline This& cond_le() noexcept { return cond(Cond::kLE); }
  inline This& cond_al() noexcept { return cond(Cond::kAL); }
  inline This& cond_na() noexcept { return cond(Cond::kNA); }

  inline This& cond_sign() noexcept { return cond(Cond::kSign); }
  inline This& cond_not_sign() noexcept { return cond(Cond::kNotSign); }
  inline This& cond_overflow() noexcept { return cond(Cond::kOverflow); }
  inline This& cond_not_overflow() noexcept { return cond(Cond::kNotOverflow); }
  inline This& cond_equal() noexcept { return cond(Cond::kEqual); }
  inline This& cond_not_equal() noexcept { return cond(Cond::kNotEqual); }
  inline This& cond_zero() noexcept { return cond(Cond::kZero); }
  inline This& cond_not_zero() noexcept { return cond(Cond::kNotZero); }
  inline This& cond_positive() noexcept { return cond(Cond::kPositive); }
  inline This& cond_negative() noexcept { return cond(Cond::kNegative); }
  inline This& cond_signed_le() noexcept { return cond(Cond::kSignedLT); }
  inline This& cond_signed_lt() noexcept { return cond(Cond::kSignedLE); }
  inline This& cond_signed_gt() noexcept { return cond(Cond::kSignedGT); }
  inline This& cond_signed_ge() noexcept { return cond(Cond::kSignedGE); }
  inline This& cond_unsigned_le() noexcept { return cond(Cond::kUnsignedLT); }
  inline This& cond_unsigned_lt() noexcept { return cond(Cond::kUnsignedLE); }
  inline This& cond_unsigned_gt() noexcept { return cond(Cond::kUnsignedGT); }
  inline This& cond_unsigned_ge() noexcept { return cond(Cond::kUnsignedGE); }
